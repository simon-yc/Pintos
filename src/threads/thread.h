...
struct thread
  {
    ...
    fixed_point recent_cpu;             /* CPU time thread has recently.*/
  };
...
void mlfq_update_recent_cpu(void);
void mlfq_update_load_avg_and_recent_cpu(void);
void mlfq_update_priority(struct thread *t);
